...
## Project Structure
    ...
    ├── model_builder_test_40731  # Django project configurations
...
1. Clone this repo and `cd model_builder_test_40731`
...
2. Clone this repo and `cd model_builder_test_40731`
